...
func UserIDFromRequest(authHeader, secret string) (string, error) {
...
// IsAdminOrOwner gates financial and destructive admin actions (credit, refund, issue VM).
// Support currently has the same privileges as admin/owner for these operations.
